...
| 7  | Order page for users<br>- error message              | All user/order information are safely stored                                      | Menu-input: salad<br>Quantity:2<br>Address:karuizawa<br>Phone:00000000000   | "Please put the name correctly"                              | Yes            |   |
| 8  | Order page for users                                 | All user/order information are safely stored                                      | Menu-input: sashimi<br>Quantity:2<br>Address:karuizawa<br>Phone:00000000000 | "Done" => redirects to the bill page.                        | Yes            |   |
