...
|    | Testing<br>Section                                   | Success Criteria                                                                  | Input                                                                              | Output                                                       | Criteria Met?: |   |
|----|------------------------------------------------------|-----------------------------------------------------------------------------------|------------------------------------------------------------------------------------|--------------------------------------------------------------|----------------|---|
| 1  | Register system for users<br>- error message         | The product contains login/sign up page                                           | Username: sample<br>Email: sample<br>Password: sample<br>Password: sample123       | "Password do not match"                                      | Yes            |   |
| 2  | Register system for users                            | The product contains login/sign up page                                           | Username: sample<br>Email: sample<br>Password: sample<br>Password: sample123       | "User account is now created" => redirects to the login page | Yes            |   |
| 3  | Login system for users<br>- error message            | The product contains login/sign up page                                           | Email: sample<br>Password: sample00                                                | "User do not exist"                                          | Yes            |   |
| 4  | Login system for users                               | The product contains login/sign up page                                           | Email: sample<br>Password: sample                                                  | "Login successful for user " => redirects to the order page  | Yes            |   |
| 5  | Order page for users<br>- displays username          | All user/order information are safely stored                                      |                                                                                    | "Welcome!, sample" on a screen                               | Yes            |   |
| 6  | Order page for users<br>- switch to another account  | All user/order information are safely stored                                      | Press the "switch to another account"                                              | "Logged out" => redirects to the login page                  | Yes            |   |
| 7  | Order page for users<br>- error message              | All user/order information are safely stored                                      | Menu-input: salad<br>Quantity:2<br>Address:karuizawa<br>Phone number:00000000000   | "Please put the name correctly"                              | Yes            |   |
| 8  | Order page for users                                 | All user/order information are safely stored                                      | Menu-input: sashimi<br>Quantity:2<br>Address:karuizawa<br>Phone number:00000000000 | "Done" => redirects to the bill page.                        | Yes            |   |
| 9  | The user-bill page shows receipts.<br>- Labels       | Total price will be automatically calculated and shown on user's digital receipt. |                                                                                    |                                                              | Yes            |   |
| 10 | User-bill page that shows receipts.<br>- Calculation | Total price will be automatically calculated and shown on user's digital receipt. |                                                                                    | "Total price {price with taxes}, expected date"              | Yes            |   |
